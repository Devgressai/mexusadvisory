...
export const people: Person[] = [
  ...
  },
  {
    ...
    practices: ["global-immigration-consulting", "risk-management"],
  ...
  },
  {
    ...
    practices: ["alternative-capital-sourcing", "jurisdictional-optimization"],
    languages: ["English", "Español"],
    tier: "member",
  },
  // ———————————————————————————————————————————— Executives
  ...
  },
  {
    ...
    practices: ["risk-management", "global-immigration-consulting"],
    languages: ["English", "Español"],
    tier: "executive",
  },
];
